...
// Muhammad saleem 4/26/2024
let personalmessage = "Muhammad saleem";
console.log(`“Hello ${personalmessage}, would you like to learn some TypeScript today?”`);//print a simple message of hello;